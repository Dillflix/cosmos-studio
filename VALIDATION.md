...
- Three SQLite queue tests passed: FIFO claiming and seed persistence,
  restart recovery without seed changes, and queued cancellation.
...
- Long-running cancellation latency, peak memory, thermal behavior, and media
